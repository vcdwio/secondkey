...
|---|---|---|
| Repository + reproducible spin-up | **Verified from GitHub** | Fresh clone of pushed `main` passed install, lint, 36 root tests, 48 agent tests and both production-only dependency audits |
